...
//mysc.methods.addNewToken(add2)
//.send({ gas: '3000000', from: "0xfe3b557e8fb62b89f4916b721be55ceb828dbd73"}).then(console.log)
mysc2.methods.balanceOf("0xfe3b557e8fb62b89f4916b721be55ceb828dbd73").call((error,result)=>{console.log({result,error})});
/*
mysc2.methods.approve(address,10000)
  .send({gas: '3000000', from: "0xfe3b557e8fb62b89f4916b721be55ceb828dbd73"}).then(console.log);
*/
mysc2.methods.transfers("0xfe3b557e8fb62b89f4916b721be55ceb828dbd73","0xdd11cb265c3ff9e98a935d82b8721f9e2626233e",100)
.send({ gas: '3000000', from: "0xfe3b557e8fb62b89f4916b721be55ceb828dbd73"}).then(console.log)
mysc2.methods.balanceOf("0xdd11cb265c3ff9e98a935d82b8721f9e2626233e").call((error,result)=>{console.log({result,error})});
