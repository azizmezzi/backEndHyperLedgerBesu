...
class EcheanceUtilisation extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div>
            <h6>Fréquence d'utilisation du service Paiement d'échéance</h6>
...
export default EcheanceUtilisation;
