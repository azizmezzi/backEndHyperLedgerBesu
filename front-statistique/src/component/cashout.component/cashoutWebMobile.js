...
class CashoutWebMobile extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    axios.get("http://3.88.223.95:3006/Cashout/getMobile/1/"+this.props.select).then(res => {
      var newData = {
        labels: ["Web", "Mobile"],
        datasets: [
          {
...
export default CashoutWebMobile;
