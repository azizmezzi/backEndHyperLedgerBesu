...
class CashoutSexMonth extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    axios.get("http://3.88.223.95:3006/Cashout/getSexByMonth/0/"+this.props.select).then(res => {
      var newData = {
        labels: ["Femme", "Homme"],
        datasets: [
          {
...
export default CashoutSexMonth;
