...
class CashoutMontantPourcentage extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    for (let j = 0; j < 500; j+=50) {
      ...
      Cashouts.push(
        await axios
          .get("http://3.88.223.95:3006/Cashout/getMontPourcentageByDay/"+1+"/"+parseInt(j)+"/"+parseInt(j+50)+"/"+this.props.select)
          .then((res4) => {
            return res4.data;
          })
      );
...
export default CashoutMontantPourcentage;
