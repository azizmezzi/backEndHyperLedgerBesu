...
class HomeCapital extends React.PureComponent {
  ...
  async componentDidMount() {
    ...
    for (let i = -8; i < 1; i++) {
      tontines.push(
        await axios
          .get("http://3.88.223.95:3006/tontine/getCapitalByWeek/" + -i+"/"+this.props.select)
          .then((res) => {
            return res.data;
          })
      );
      echeances.push(
        await axios
          .get("http://3.88.223.95:3006/echeance/getCapitalByWeek/" + -i+"/"+this.props.select)
          .then((res1) => {
            return res1.data;
          })
      );
      cashins.push(
        await axios
          .get("http://3.88.223.95:3006/cashin/getCapitalByWeek/" + -i+"/"+this.props.select)
          .then((res2) => {
            return res2.data;
          })
      );
      cashouts.push(
        await axios
          .get("http://3.88.223.95:3006/cashout/getCapitalByWeek/" + -i+"/"+this.props.select)
          .then((res3) => {
            return res3.data;
          })
      );
      transfers.push(
        await axios
          .get("http://3.88.223.95:3006/transfer/getCapitalByWeek/" + -i+"/"+this.props.select)
          .then((res4) => {
            return res4.data;
          })
      );
