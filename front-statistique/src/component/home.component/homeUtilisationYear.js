...
class HomeUtilisationYear extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    for (let i = -8; i < 1; i++) {
      responses.push(
        await axios
          .get("http://3.88.223.95:3006/tontine/getUsesByYear/" + -i+"/"+this.props.select)
          .then(res => {
            return res.data;
          })
      );
      responses1.push(
        await axios
          .get("http://3.88.223.95:3006/echeance/getUsesByYear/" + -i+"/"+this.props.select)
          .then(res1 => {
            return res1.data;
          })
      );
      responses2.push(
        await axios
          .get("http://3.88.223.95:3006/cashin/getUsesByYear/" + -i+"/"+this.props.select)
          .then(res2 => {
            return res2.data;
          })
      );
      responses3.push(
        await axios
          .get("http://3.88.223.95:3006/cashout/getUsesByYear/" + -i+"/"+this.props.select)
          .then(res3 => {
            return res3.data;
          })
      );
      responses4.push(
        await axios
          .get("http://3.88.223.95:3006/transfer/getUsesByYear/" + -i+"/"+this.props.select)
          .then(res4 => {
            return res4.data;
          })
      );
...
export default HomeUtilisationYear;
