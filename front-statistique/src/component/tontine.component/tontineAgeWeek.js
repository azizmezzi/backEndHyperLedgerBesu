...
class TontineAgeWeek extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    axios.get("http://3.88.223.95:3006/Tontine/getAgeByWeek/0/"+this.props.select).then(res => {
      var newData = {
        labels: ["Adule", "Jeune"],
        datasets: [
          {
