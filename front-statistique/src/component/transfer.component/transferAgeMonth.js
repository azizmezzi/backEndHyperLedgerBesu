...
class TransferAgeMonth extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    axios.get("http://3.88.223.95:3006/transfer/getAgeByMonth/0/"+this.props.select).then(res => {
      var newData = {
        labels: ["Adulte", "Jeune"],
        datasets: [
          {
...
export default TransferAgeMonth;
